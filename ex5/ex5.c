...
int main(void)
{
    ...
    int fd[2];           // a two-element array to hold the read and write file descriptors that are used by the pipe
    ...
    { // child process satisfies this branch
        ...
        // write 16 bytes of data to the write file descriptor in child
